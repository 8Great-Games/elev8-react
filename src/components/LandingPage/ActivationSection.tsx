...
export default function ActivationSection() {
    ...
    return (
        <div className="w-full bg-brand-950 text-white antialiased rounded-t-[48px] rounded-b-[48px]">
            {/* Top spacing */}
            ...
            {/* Pricing card area */}
            <div className="rounded-t-[48px] rounded-b-[48px] bg-white/95 py-16 text-slate-800 backdrop-blur antialiased">
                    ...
                    <div className="col-span-1 rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5">
                        ...
                        <div className="mt-8 flex items-end gap-2">
                            ...
                            <span className="mb-2 text-slate-500">
                                {billing === "monthly" ? "monthly ($49/seat)" : "yearly ($399/seat)"}
                            </span>
                        </div>

                        <CheckoutButton planName={`${billing}_${value}`} />
